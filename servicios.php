...
?> 
    ...
    <div id="propiedad-popup" class="white-popup mfp-hide bio">
        ...
        <div class="section group serveDesc">       
                <p><?php echo translator("En MIAPatents protegemos los derechos de artistas y creadores, en especial los desarrollos de software, a través de estrategias de protección personalizados, caso por caso.") ?></p>
        </div>
    </div>
